                            ...
                            <div className="col-lg-3">
                                <div className="footer-widget footer-widget__about">
                                    <img src="/assets/images/resources/logo-dark.png" width="119" alt=""
                                        ...
                                        <p className="footer-widget__contact"><a href="tel:888-666-0000">+91 7000 082 359</a></p>
                                        <p className="footer-widget__contact"><a
                                            href="mailto:needhelp@example.com">atinivinfo@gmail.com</a></p>
                ...
                <div className="site-footer__bottom">
                    <div className="container">
                        <div className="inner-container text-center">
                            <p className="site-footer__copy">&copy; copyright 2021 by <a href="#">Atiniv.com</a></p>
                        </div>
                    </div>
                </div>
            </footer>
