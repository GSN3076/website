                    ...
                    <div className="video-one__box ">
                        <img src="/assets/images/resources/video-1-1.jpg" alt="" />
                            <div className="video-one__content">
                                <ModalVideo channel='youtube' isOpen={this.state.isOpen} videoId='XHgfrspHJVQ' onClose={() => this.setState({isOpen: false})} />
                                <div onClick={this.openModal} className="video-popup video-one__btn"><i className="fa fa-play"></i>
                                </div>

                                <h2 className="video-one__title">Watch Our <span>Products</span> <br /> Videos.
                                </h2>
                            </div>
                    </div>
                </div>
