                            ...
                            <div className="item">
                                <div className="testimonials-one__single">
                                    <div className="testimonials-one__inner">
                                        ...
                                        <img src="/assets/images/resources/logo-bskil.jpg" alt="bskill logo" />
                                    </div>
                                </div>
                            </div>
                            <div className="item">
                                <div className="testimonials-one__single">
                                    <div className="testimonials-one__inner">
                                        <p>Yeah , Service is good to start your business from scratch<br/> <br/></p>
                                        <h3>Motion Media</h3>
                                        <span>Our Customers</span>
                                        <img src="/assets/images/resources/mm.png" alt="motionmedia logo" />
                                    </div>
                                </div>
                            </div>
                            {/* <div className="item">
